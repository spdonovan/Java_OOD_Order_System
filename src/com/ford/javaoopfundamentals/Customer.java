...
public class Customer implements Comparable<Customer> {
    ...
    public Optional<Order> checkout(ShoppingCart cart, String paymentHethodNickname) {
        Optional<PaymentMethod> paymentMethod =
        Optional.ofNullable(paymentMethods.get(paymentHethodNickname));
    ...
    @Override
    public int compareTo(Customer o) { return name.compareTo(o.name); }
